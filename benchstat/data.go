...
type Collection struct {
	...
	// ShowDelta enables you to compare against best/worst case
	ShowDelta bool

	// DeltaWorst is a toggle you can set if you want to compare against worst case instead of best case
	DeltaWorst bool
}
